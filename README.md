...
Code for generating main and supplementary figures can be found in Payne-et-al-2025\_Figures.R

## Tables 

Code for generating supplementary tables as well as statistical analysis referenced in the
paper can be found in Payne-et-al-2025\_Tables.R

## Contributing

Questions, comments, and suggestions are always welcome, please feel free to send them to the 
repository owner (cypayne at ucsc dot edu)
